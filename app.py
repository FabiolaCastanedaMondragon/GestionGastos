...
def delete_category(user_id):
    ...
    responses:
      ...
      403:
        description: Categoría estándar no eliminable
      404:
        description: Categoría no encontrada
      500:
        description: Error interno del servidor
...
def problematic_category(user_id):
    ...
    responses:
      200:
        description: Categoría problemática calculada
        schema:
          type: object
          properties:
            category:
...
def monthly_report():
    """
    Obtener reporte mensual con tendencia por categoría.
    ---
    tags:
      - Reportes
    parameters:
...
def add_transaction(user_id):
    """
    Agregar una transacción financiera.
    ---
    tags:
      - Transacciones
    parameters:
...
def get_balance(user_id):
    ...
    responses:
      200:
        description: Saldo calculado correctamente
        schema:
          type: object
          properties:
            current_balance:
